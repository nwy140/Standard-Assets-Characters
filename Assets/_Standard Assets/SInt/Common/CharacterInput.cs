...
namespace StandardAssets.Characters.Common
{
    ...
    public abstract class CharacterInput : MonoBehaviour // StandardControls.IMovementActions
    {
        ...
        public struct Sensitivity
        {
            ...
            {
                get { return m_MouseVertical; }
            }

            public float mouseHorizontalSensitivity
            {
                get { return m_MouseHorizontal; }
            }

            public float gamepadVerticalSensitivity
            {
                get { return m_GamepadVertical; }
            }

            public float gamepadHorizontalSensitivity
            {
                get { return m_GamepadHorizontal; }
            }

            public float touchVerticalSensitivity
            {
                get { return m_TouchVertical; }
            }

            public float touchHorizontalSensitivity
            {
                get { return m_TouchHorizontal; }
            }
        }
        ...
        void Awake()
        {
            ...
            {
                Debug.LogWarning(
                    "No CinemachineInputGainDampener component detected, make sure Cinemachine axis control speed mode is set to 'Max Speed' or add a CameraInputGainAcceleration component to this character");
            }
